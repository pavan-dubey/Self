...
const NewAssignRequestInt = () => {
    const pathName = usePathName();
    const navigate = useNavigate();
    let RoleName = localStorage.getItem("RoleName");
    const Username = localStorage.getItem("UserName");
    let isASMflow = localStorage.getItem("isASMflow");
    ...
    const [showMultipleProdTicket, setshowMultipleProdTicket] = useState(false)


    const handleShowMultipleProduct = () => setshowMultipleProdTicket(true)

    const handleCloseMultipleProduct = () => setshowMultipleProdTicket(false)
    ...
    const [changeInProduct, setchangeInProduct] = useState(false)
            ...
            fetch(`${process.env.REACT_APP_API_URL}Activity/GetAllTypeOfWorkDone?serviceTicketId=${serTicId}&FrameSizeType=""&KVAType=""`, {
                ...
                .then((result) => {
                    ...
                    settab3((pre) => {
                        return {
                            ...pre,
                            TypeOfWorkDoneId: filterEngg?.map((activity) => ({
    ...
    const [errorMessageTagNo, setErrorMessageTagNo] = useState('');
    ...
    const [tab3InvoiceFileName, settab3InvoiceFileName] = useState("")
    ...
    const allStatus = (division) => {
        fetch(`${process.env.REACT_APP_API_URL}Common/GetAllActivityStatus?ServiceTicketId=${serTicId}&ActivityType=${(tab1?.serviceRequestSubStatusId == "30" || submittedDataTab1?.serviceRequestSubStatusId == "30") ? 163 : 164}&DivisionCode=${division}`, {
            ...
            .then((result) => {
                ...
                if ((ticketInfo[0]?.divisionCode != 'M4') || (ticketInfo[0]?.divisionCode != "M3")) {
                    console.log(result);
                    setactivityStatus(result)
                }

                if ((!siteVisitExists) && (ticketInfo[0]?.divisionCode == "M4")) {
                ...
                if ((!siteVisitExists) && (ticketInfo[0]?.productLineCode == "C1")) {
                    let filtered = result?.filter(i => i?.parameterTypeId == "26")
                    console.log(filtered);
                    setactivityStatus(filtered)
                ...
                if ((!siteVisitExists) && (ticketInfo[0]?.divisionCode == "M3") && acknowledgementStatus != "Product received at workshop") {
                ...
                if (acknowledgementStatus == "Product received at workshop" || (tab1?.serviceRequestSubStatusId == "28" || submittedDataTab1?.serviceRequestSubStatusId == "28")) {
                    console.log(result);
                    setactivityStatus(result)
                }
    ...
    const fetchdataById = () => {
        ...
        fetch(
            ...
            .then((result) => {
                ...
                if (result) {
                    ...
                    settab3((pre) => {
                        return {
                            ...
                            ManufacturingDate: result[0]?.manufacturingDate,
                            DateOfDispatch: result[0]?.dateOfDispatch,
                            // FrameSizeId: result[0]?.frameSizeId ? result[0]?.frameSizeId : 0
                        }
                    })


                    setchangeProduct((pre) => {
                        return {
                            ...pre,
                            serialNo: result[0]?.sernr,
                            productCode: result[0]?.matnr,
                ...
                //         if(result[0]?.divisionCode=="CP" && result[0]?.productLineCode=="FD"){
                //             let FDDefects=resultDef?.filter(i=>i?.productGroupName=="ALL PURPOSE FANS")
                //             console.log(FDDefects);

                //         setdefectCategories(FDDefects)

                //         }
                //         else if(result[0]?.divisionCode=="CP" && result[0]?.productLineCode=="C2"){
                //             let ApplDefects=resultDef?.filter(i=>i?.defectCategoryId=="415")
                //             console.log(ApplDefects);

                //             setdefectCategories(ApplDefects)
                //         }
                //         else{
                //             console.log(resultDef);

                //             setdefectCategories(resultDef)
                //         }
                ...
                else if (result[0]?.tabActive == "Tab2") {
                    setactiveKeyEdit("2")
                }
                else if (isASMflow == "true" && result[0]?.tabActive == "Tab3") {
                    setactiveKeyEdit("2")
                }
        ...
        fetch(`${process.env.REACT_APP_API_URL}AscServiceTicketCustomer/GetServiceTicketTaskDetailsByIdAsync?ServiceTicketId=${serTicId}`, {
            ...
            .then(((result) => {
                ...
                if (result?.ascServiceTicketFirlist[0]) {
                    ...
                    settab3((pre) => {
                        return {
                            ...
                            FrameSizeId: result?.ascServiceTicketFirlist[0]?.frameSizeId ? result?.ascServiceTicketFirlist[0]?.frameSizeId : 0
                ...
                settab3((pre) => {
                    return {
                        ...pre,
                        SerialNo: result?.ascServiceTicketCustomer[0]?.serialNo?result?.ascServiceTicketCustomer[0]?.serialNo:'',
                        ProductCode: result.ascServiceTicketCustomer[0]?.productCode,
                ...
                if (result?.ascServiceTicketFirlist?.length > 0) {
                    ...
                    if (result?.ascServiceTicketFirlist[0]?.invoiceFile) {
                        let docPath = result?.ascServiceTicketFirlist[0]?.invoiceFile || '';
                        const [firstPart, restOfString] = docPath.split(/_(.+)/);

                        settab3InvoiceFileName(restOfString)
    ...
    useEffect(() => {
        ...
        fetch(
            ...
            .then((result) => {
                ...
                let div = ticketInfo[0]?.divisionCode == 'DR' || ticketInfo[0]?.divisionCode == 'M7' || ticketInfo[0]?.productLineCode === 'C2' || ticketInfo[0]?.productLineCode === 'FD'
                ...
                if (div) {
                    ...
                    // console.log(filtered);
                    if (isASMflow == "true") {
                        // filtered = filtered?.filter(i => i?.stSubStatusName != "Technician Assigned")
        ...
        if (ticketInfo[0]?.divisionCode == 'DR' && ticketInfo[0]?.divisionCode == 'M4' && ticketInfo[0]?.divisionCode == 'CP' && ticketInfo[0]?.divisionCode == 'M3') {
            fetch(`${process.env.REACT_APP_API_URL}Activity/GetAllTypeOfWorkDone?serviceTicketId=${serTicId}&FrameSizeType=""&KVAType=""`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
    ...
    const [selectedKVAList, setselectedKVAList] = useState([])
    ...
    const getKVAList = () => {
        if (tab3?.Kva) {
            ...
            fetch(`${process.env.REACT_APP_API_URL}Common/GetAllCommon?mode=40&Id=${serTicId}&Code=${tab3?.Kva ? tab3?.Kva : 0}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            })
                .then((res) => res.json())
                .then((resultKVA) => {
                    console.log(resultKVA);



                    let listKVA = resultKVA?.map((kva) => ({ label: kva?.parameterType, value: kva?.parameterTypeId }))
    ...
    const getFrameList = () => {
        fetch(`${process.env.REACT_APP_API_URL}Common/GetAllCommon?mode=41&Id=${serTicId}&Code=${0}`, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        })
    ...
    useEffect(() => {
        ...
        if (ticketInfo[0]?.divisionCode == 'M4' || ticketInfo[0]?.divisionCode == 'DR' || ticketInfo[0]?.divisionCode == 'M3' || ticketInfo[0]?.divisionCode == 'CP') {
            let KVAs = selectedKVAList?.map(i => i?.value).join(",")
            fetch(`${process.env.REACT_APP_API_URL}Activity/GetAllTypeOfWorkDone?serviceTicketId=${serTicId}&FrameSizeType=${selectedFrameTypes ? selectedFrameTypes : "0"}&KVAType=${KVAs ? KVAs : "0"}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            })
    ...
    }, [selectedKVAList, selectedFrameTypes, ticketInfo])
        ...
        if (addActivity?.activeStatusId) {
            ...
            fetch(
                ...
                .then((result) => {
                    ...
                    setFilteredOptions(changedActivities)
                });
        }
    ...
    useEffect(() => {
        // Check if specific activities are selected
        const is60Selected = selected.some((item) => item.value === 60);
        const is61Selected = selected.some((item) => item.value === 61);
        const is75Selected = selected.some((item) => item.value === 75);
        const is97Selected = selected.some((item) => item.value === 97);
        const is98Selected = selected.some((item) => item.value === 98);
        const is99Selected = selected.some((item) => item.value === 99);
        const is100Selected = selected.some((item) => item.value === 100);
        const isSelected105 = selected.some((item) => item.value === 105);
        const isSelected106 = selected.some((item) => item.value === 106);
        const isSelected107 = selected.some((item) => item.value === 107);
        const isSelected108 = selected.some((item) => item.value === 108);
        const isSelected19 = selected.some((item) => item.value === 19);
        const isSelected111 = selected.some((item) => item.value === 111);
        const isSelected112 = selected.some((item) => item.value === 112);
        const isSelected113 = selected.some((item) => item.value === 113);
        const isSelected110 = selected.some((item) => item.value === 110);
        const isSelected109 = selected.some((item) => item.value === 109);
        ...
        let updatedOptions = [...Activities];

        // Handle 60 ↔ 61
        if (is60Selected) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 61);
        } else if (is61Selected) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 60);
        }

        // Handle 75 ↔ 97
        if (is75Selected) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 97);
        } else if (is97Selected) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 75);
        }

        // Handle 98 ↔ (99 & 100)
        if (is98Selected) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 99 && option.value !== 100);
        }

        // Handle 99 ↔ (98 & 100)
        if (is99Selected) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 98 && option.value !== 100);
        }

        // Handle 100 ↔ (98 & 99)
        if (is100Selected) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 98 && option.value !== 99);
        }

        // Set filtered options based on conditions
        if (isSelected105) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 106 && option.value !== 107 && option.value !== 108 && option.value !== 19);
        }
        if (isSelected106) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 105 && option.value !== 107 && option.value !== 108 && option.value !== 19);
        }
        if (isSelected107) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 105 && option.value !== 106 && option.value !== 108 && option.value !== 19);
        }
        if (isSelected108) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 105 && option.value !== 106 && option.value !== 107 && option.value !== 19);
        }
        if (isSelected19) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 105 && option.value !== 106 && option.value !== 107 && option.value !== 108);
        }
        if (isSelected111) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 112);
        }
        if (isSelected112) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 111);
        }
        if (isSelected113) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 110 && option.value !== 111);
        }
        if (isSelected110) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 109 && option.value !== 113);
        }
        if (isSelected109) {
            updatedOptions = updatedOptions.filter((option) => option.value !== 111 && option.value !== 110);
        }
    ...
    const handleVerify = (e) => {
        e.preventDefault();
        if (tab1?.contactDate == "" || tab1?.invoiceNo == "" || tab1?.invoiceDate == "") {
            Swal.fire({
                icon: "error",
                title: "Please fill all the fields marked with red *!"
            })
        }
        else if ((ticketInfo[0]?.divisionCode == 'M3' || ticketInfo[0]?.divisionCode == 'CP' || ticketInfo[0]?.divisionCode == 'M4') && tab1?.serialNo == "") {
            Swal.fire({
                icon: "error",
                title: "Serial number is required!"
            })
        }
        else if ((ticketInfo[0]?.divisionCode == 'M3' || ticketInfo[0]?.divisionCode == 'CP' || ticketInfo[0]?.divisionCode == 'M7' || ticketInfo[0]?.divisionCode == 'M4') && tab1?.productCode == "") {
            Swal.fire({
                icon: "error",
    ...
    const isDistanceAbove200 = Number(tab4Deviation?.CurrentDistance) > 200;
    const isDistanceAbove51 = Number(tab4Deviation?.CurrentDistance) > 50;
    ...
    const isDistanceAbove250 = Number(tab4Deviation?.CurrentDistance) < 250;



    const dis = Number(ticketInfo[0]?.distance) > 100
    console.log(dis)
    ...
    const [minInvoiceDateProdChange, setMinInvoiceDateProdChange] = useState('');


    const [minProdDateForMultipleProds, setminProdDateForMultipleProds] = useState("")
    ...
    const [addMultpleProducts, setaddMultpleProducts] = useState({
        serviceTicketId: serTicId,
        serialNo: "",
        productCode: "",
        divisionCode: "",
    ...
    const [addMultpleProductsTable, setaddMultpleProductsTable] = useState({
        serviceTicketId: serTicId,
        serialNo: "",
        productCode: "",
        division: "",
    ...
    const [AddedMultipleProducts, setAddedMultipleProducts] = useState([])
    const [AddedMultipleProductsTable, setAddedMultipleProductsTable] = useState([])




    const handleRemoveMulipleProducts = (index) => {
        const updatedData = [...AddedMultipleProducts];
        const updatedData1 = [...AddedMultipleProductsTable];

        updatedData.splice(index, 1);
        updatedData1.splice(index, 1);

        setAddedMultipleProducts(updatedData);
        setAddedMultipleProductsTable(updatedData1);
    ...
    const handleAddMultipleProducts = () => {
        ...
        if (addMultpleProducts?.serialNo == "" || addMultpleProducts?.productCode == "" || addMultpleProducts?.pInvoiceNo == "" || addMultpleProducts?.pInvoiceDate == "") {
            Swal.fire({
                icon: "error",
                title: "Please fill all the fields marked with red *!"
            })
            ...
            setAddedMultipleProducts([...AddedMultipleProducts, addMultpleProducts]);
            setAddedMultipleProductsTable([...AddedMultipleProductsTable, addMultpleProductsTable]);
            // settab3((pre) => {
            //     return {
            //         ...pre,
            ...
            console.log(AddedMultipleProducts);
            console.log(AddedMultipleProductsTable);
    ...
    const debouncedSerailNumberForMultipleProducts = (selectedSerial) => {
        ...
        timeoutRef.current = setTimeout(() => {
            ...
            fetch(
                `${process.env.REACT_APP_API_URL}ServiceTicket/GetAllSerialWiseServiceTicketInfoFIR?SerialNo=${addMultpleProducts?.serialNo}&ProductCode=${addMultpleProducts?.productCode || "0"}&InvoiceDate=${addMultpleProducts?.pInvoiceDate || ""}&DivisionCode=${ticketInfo[0]?.divisionCode}`,
                {
                    headers: {
                        Authorization: `Bearer ${token}`,
                    },
                ...
                .then((result) => {
                    ...
                    if (result[0]?.msgCode === "SAP101") {
                        ...
                        a = moment(a).format("YYYY-MM-DD");
                        let d1 = new Date(a);
                        let d2 = new Date(addMultpleProducts.pInvoiceDate);
                        // console.log(a, 'a---------');
                        setminProdDateForMultipleProds(a);

                        console.log(minProdDateForMultipleProds);
                        if (d1 > d2) {
                            setaddMultpleProducts((pre) => ({
                                ...pre,
                                pInvoiceDate: ""
                            }));
                        }
                        ...
                        setaddMultpleProducts((pre) => ({
                            ...
                            division: result[0]?.divisionName || '',

                            productLine: result[0]?.productLineName || '',
    ...
    const handleRadioChangee = (event) => {
        ...
        settabClaim((pre) => {
            return {
                ...pre,
                wayToDistance: event.target.value,
                ClaimDeviationTypeId: ticketInfo[0]?.divisionCode == 'DR' ? "4" : ticketInfo[0]?.divisionCode == 'M4' ? "3" : ticketInfo[0]?.divisionCode == 'M3' ? "8" : '0'
            ...
            fetch(
                ...
                .then((result) => {
                    ...
                    if (result[0]?.msgCode === "SAP101") {
                        ...
                        a = moment(a).format("YYYY-MM-DD");
                        let d1 = new Date(a);
                        let d2 = new Date(tab3.InvoiceDate);
                        // console.log(a, 'a---------');
                        setMinInvoiceDate(a);

                        console.log(minInvoiceDate);
                        if (d1 > d2) {
                            settab3((pre) => ({
                                ...pre,
                                InvoiceDate: ""
    ...
    useEffect(() => {
        fetch(`${process.env.REACT_APP_API_URL}Common/GetAllCommon?mode=43&Code=0&Id=0`, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        }).then((res) => res.json())
            .then((result) => {
                ...
                setreplacementReasons(result)

            })
    }, [tab3?.ClosureStatusId])
    ...
    const getClosureStatus = () => {
        fetch(`${process.env.REACT_APP_API_URL}Common/GetAllCommon?mode=35&Code=${tab3?.DivisionCode ? tab3?.DivisionCode : 0}&Id=${serTicId}`, {
            headers: {
                Authorization: `Bearer ${token}`,
            },
        })
    ...
    // const LTMtypeofworkDone = optionsypeWorkdone?.map(value => value?.value).join(",")

    // console.log(LTMtypeofworkDone);
    ...
    const [showProdChange, setshowProdChange] = useState(false)


    const handleShowProdChange = () => {
        fetchdataById()

        setshowProdChange(true)
    }
    const handleCloseProdChange = () => {
        setchangeInProduct(false)
        setshowProdChange(false)
    }
    ...
    useEffect(() => {
        ...
        let existsNot = addActivityItenTable?.some(i => i?.statusName == "Product required at ASC" && (i?.subStatusName == "Product received at ASC" || i?.subStatusName == "Product not received at ASC"))
        console.log(exists);
        console.log(addActivityItenTable);
        ...
        if (exists && !existsNot) {
            ...
            fetch(`${process.env.REACT_APP_API_URL}Common/GetAllActivitySubStatus?ServiceTicketId=${serTicId}&ActivityStatusId=${25}`, {
                headers: {
                    Authorization: `Bearer ${token}`,
                },
            })
    ...
    let CPDistance = ticketInfo[0]?.distance > 51
    console.log(CPDistance);
    ...
    useEffect(() => {
        fetch(`${process.env.REACT_APP_API_URL}ASMServiceTicketClaimApproval/GetAllSpecialApprovalClaim?serviceTicketId=${serTicId}`, {
            headers: {
                Authorization: `Bearer ${token}`,
            }
        })
...
a
                                                                            ...
                                                                            <Form.Group>
                                                                                ...
                                                                                <Form.Control
                                                                                    ...
                                                                                    onChange={(e) => {
                                                                                        ...
                                                                                        handleChange(e)
                                                                                        fetch(
                                                                                            `${process.env.REACT_APP_API_URL}ServiceTicket/GetAllSerialWiseServiceTicketInfoFIR?SerialNo=${selectedSerail ? selectedSerail : ""}&ProductCode=${tab1?.productCode ? tab1?.productCode : "0"}&InvoiceDate=${tab1?.invoiceDate ? tab1?.invoiceDate : ""}&DivisionCode=${ticketInfo[0]?.divisionCode} `,
                                                                                            ...
                                                                                            .then((result) => {
                                                                                                ...
                                                                                                // }
                                                                                                // else if (result[0]?.msgCode === "SAP101") {
                                                                                                //     Swal.fire({
                                                                                                //         icon: "error",
                                                                                                //         title: result[0]?.msg
                                                                                                //     })
                                                                                ...
                                                                                <Col md={1} >
                                                                                    <Button
                                                                                        ...
                                                                                        onClick={() => {
                                                                                            ...
                                                                                            else if (isASMflow == "false" && tab1?.serviceRequestSubStatusId == '30' && tab1?.technicianId == '0') {
                                                                                                Swal.fire({
                                                                                                    icon: 'error',
                                                    ...
                                                    <Accordion.Item eventKey="1">
                                                        ...
                                                        <Accordion.Body className='pt-0 pb-1'>
                                                            ...
                                                            {/* <Row>
                                                                <Col>
                                                                <Form.Group>
                                                                    <Form.Label>Is product changed?</Form.Label>
                                                                    <div className='d-flex gap-4'>
                                                                        <Form.Check type='radio' name='changeProduct' label="Yes" checked={changeInProduct} onChange={ (e)=>{

                                                                            setchangeInProduct(true)


                                                                            handleShowProdChange()
                                                                        ...
                                                                        <Form.Check type='radio' name='changeProduct' label="No" checked={!changeInProduct} onChange={(e)=>{
                                                                            setchangeInProduct(false)
                                                    ...
                                                    <Accordion.Item eventKey="2">
                                                                        ...
                                                                        <Form.Group>
                                                                            ...
                                                                            <Form.Control
                                                                                ...
                                                                                onChange={(e) => {
                                                                                    ...
                                                                                    handleChangeTab3(e)
                                                                                    fetch(
                                                                                        `${process.env.REACT_APP_API_URL}ServiceTicket/GetAllSerialWiseServiceTicketInfoFIR?SerialNo=${tab3?.SerialNo ? tab3?.SerialNo : "0"}&ProductCode=${selectedP || "0"}&InvoiceDate=${tab3?.InvoiceDate || ""}&DivisionCode=${ticketInfo[0]?.divisionCode}`,
                                                                                        {
                                                                                            headers: {
                                                                                                Authorization: `Bearer ${token}`,
                                                                                            },
                                                        ...
                                                        <Row className="mt-2"> */}
                                                                    ...
                                                                    {(ticketInfo[0]?.productLineCode == "M7" || ticketInfo[0]?.divisionCode == "DR") ? '' : (
                                                                        <Col md={2} className="mt-3" >
                                                                            <Form.Group>
                                                                ...
                                                                <Row className='mt-2'>
                                                                    ...
                                                                    {(ticketInfo[0]?.divisionCode == "M4" || (ticketInfo[0]?.divisionCode == "CP" && ticketInfo[0]?.productLineCode == "C1")) ? <Col md={2} >
                                                                        <Form.Group>
                                                                            ...
                                                                            <Form.Control
                                                                                ...
                                                                                readOnly={ticketInfo[0]?.tabActive == "Tab3" || ticketInfo[0]?.tabActive == "Tab4" || verifyFristStepFir || ticketInfo[0]?.productLineCode == 'C1'}
                                                                                value={tab3.Hp}
                                                                                onChange={handleChangeTab3}
                                                                    ...
                                                                    <Col md={2}>
                                                                        <Form.Group>
                                                                            ...
                                                                            <Form.Control
                                                                                ...
                                                                                min={moment(
                                                                                    tab3?.ManufacturingDate || minInvoiceDate
                                                                                )?.format("YYYY-MM-DD")}
                                                                                max={currentDate}
                                                                                value={moment(
                                                                                    ...
                                                                                    if (invoiceDateStrr) {
                                                                                        ...
                                                                                        settab3((pre) => {
                                                                                            return {
                                                                                                ...
                                                                                                DateOfCommissioning: ticketInfo[0]?.divisionCode == 'M7' ? '' : ''
                                                                                            }
                                                                                        })
                                                                                        ...
                                                                                        fetch(
                                                                                            `${process.env.REACT_APP_API_URL}ServiceTicket/GetAllSerialWiseServiceTicketInfoFIR?SerialNo=${tab3?.SerialNo || 0}&ProductCode=${tab3?.ProductCode || "0"}&InvoiceDate=${tab3?.InvoiceDate || ""}&DivisionCode=${ticketInfo[0]?.divisionCode}`,
                                                                                            {
                                                                                                headers: {
                                                                                                    Authorization: `Bearer ${token}`,
                                                                                                },
                                                                        ...
                                                                        ((tab3?.DivisionCode === 'DR' || tab1?.divisionCode === 'DR' || ticketInfo[0]?.divisionCode == "DR") || (tab3?.DivisionCode == 'M7' || tab1?.divisionCode === 'M7' || ticketInfo[0]?.divisionCode == "M7")) && (
                                                                            ...
                                                                            <>
                                                                                <Col md={2}>
                                                                                    ...
                                                                                    <Form.Control type='date'
                                                                                        readOnly={ticketInfo[0]?.divisionCode == 'DR' || ticketInfo[0]?.tabActive == "Tab3" || ticketInfo[0]?.tabActive == "Tab4" || verifyFristStepFir}
                                                                                ...
                                                                                {
                                                                                    ticketInfo[0]?.defectDesc == 'Commissioning or Installation' ? "" :
                                                                                        <Col md={2}>
                                                                                            <Form.Label> Product Failure date </Form.Label>
                                                                                            <Form.Control type='date' name="ProductFailureDate"
                                                                                                readOnly={ticketInfo[0]?.tabActive == "Tab3" || ticketInfo[0]?.tabActive == "Tab4" || verifyFristStepFir}
                                                                                                min={moment(
                                                                                                    tab3?.DateOfCommissioning || tab3?.InvoiceDate
                                                                                                )?.format("YYYY-MM-DD")}
                                                                                                max={currentDate}
                                                                                                value={moment(
                                                                                                ...
                                                                                                onChange={(e) => {
                                                                                                    settab3((pre) => {
                                                                                                        return {
                                                                                                            ...pre,
                                                                                                            ProductFailureDate: e.target.value,
                                                                                                            FailureReportedDate: ''
                                                                                    ...
                                                                                    ticketInfo[0]?.defectDesc == 'Commissioning or Installation' ? "" :
                                                                                        <Col md={2}>
                                                                                            ...
                                                                                            <Form.Control type='date' name="FailureReportedDate"
                                                                                                ...
                                                                                                min={moment(
                                                                                                    tab3?.ProductFailureDate || tab3?.InvoiceDate
                                                                                                )?.format("YYYY-MM-DD")}
                                                                                                max={currentDate}
                                                                    ...
                                                                    <Col md={2}>
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            {(verifiedWarrantyStatus == "NA" || ticketInfo[0]?.divisionCode == 'DR' || ticketInfo[0]?.divisionCode == 'M7') ? "" : (
                                                                                <span style={{
                                                                                    fontSize: '12px',
                                                                                    textAlign: 'center',
                                                                                    marginLeft: '2px'
                                                                ...
                                                                <Form.Group>
                                                                    ...
                                                                    {ticketInfo[0]?.tabActive == "Tab3" || ticketInfo[0]?.tabActive == "Tab4" || verifyFristStepFir ? tab3?.InvoiceFile ?
                                                                        <Col md={2}>
                                                                            <Form.Group>
                                                                                <Form.Label>Download invoice </Form.Label>
                                                                                <p className='m-0 p-0 text-center'> <span style={{ fontSize: "11px" }}>{tab3InvoiceFileName}</span> <FaDownload
                                                                                    fontSize={20} color='#7bc143' style={{ cursor: "pointer" }} className='mx-4 pointer'
                                                                                    onClick={(e) => {
                                                                                        e.preventDefault();
                                                                        ...
                                                                        <Form.Group>
                                                                            <Form.Label>Upload invoice copy  <span className="req-t">*</span></Form.Label>
                                                                            <Form.Control type='file' accept=".jpg, .jpeg, .doc, .docx,.png"
                                                                                onChange={(e) => {
                                                                    ...
                                                                    {(ticketInfo[0]?.divisionCode == "CP" && ticketInfo[0]?.productLineCode != "C1") ? "" : <Col md={2}>
                                                                        <Form.Group>
                                                                            ...
                                                                            <Form.Control type='number'
                                                                                ...
                                                                                name="NoOfHours"
                                                                                readOnly={ticketInfo[0]?.tabActive == "Tab3" || ticketInfo[0]?.tabActive == "Tab4" || verifyFristStepFir}
                                                                                value={tab3?.NoOfHours && Math.max(0, tab3?.NoOfHours)}
                                                                                onChange={handleChangeTab3}
                                                                            />
                                                                        </Form.Group>
                                                                    </Col>}
                                                                                ...
                                                                                >
                                                                                    <Button
                                                                                        ...
                                                                                        onClick={(e) => {
                                                                                            ...
                                                                                            else if ((ticketInfo[0]?.divisionCode == "M3") && (tab3?.FrameSizeId == '' || tab3?.FrameSizeId == "0")) {
                                                                                                Swal.fire({
                                                                                                    icon: "error",
                                                                                                    title: "Frame Slot is required!"
                                                                                                })
                                                                                                        ...
                                                                                                        if (result[0]?.serialNo === tab3?.SerialNo) {
                                                                                                            if (result[0]?.warrantyDateStatus) {
                                                                                                                ...
                                                                                                                let obj = {
                                                                                                                    ...
                                                                                                                    ManufacturingDate: tab3?.ManufacturingDate ? tab3?.ManufacturingDate : '',
                                                                                                                    DateOfDispatch: tab3?.DateOfDispatch ? tab3?.DateOfDispatch : "",
                                                                                                                ...
                                                                                                                fetch(
                                                                                                                    ...
                                                                                                                    resp.then((r) => {
                                                                                                                        ...
                                                                                                                        if (r.match(regextest)) {
                                                                                                                            ...
                                                                                                                            fetch(`${process.env.REACT_APP_API_URL}DefectCategory/GetAllDefectCategory?DivisionCode=${ticketInfo[0]?.divisionCode}&ProductLineCode=${ticketInfo[0]?.productLineCode}`, {
                                                                                                                                headers: {
                                                                                                                                    Authorization: `Bearer ${token}`,
                                                                                                                                },
                                                                                                                            })
                                                                                                                                ...
                                                                                                                                .then((resultDef) => {
                                                                                                                                    ...
                                                                                                                                    if (ticketInfo[0]?.divisionCode == "CP" && ticketInfo[0]?.productLineCode == "FD") {
                                                                                                                                        let FDDefects = resultDef?.filter(i => i?.defectCategoryId == "414")
                                                                                                                                        console.log(FDDefects);

                                                                                                                                        setdefectCategories(FDDefects)

                                                                                                                                    }
                                                                                                                                    else if (ticketInfo[0]?.divisionCode == "CP" && ticketInfo[0]?.productLineCode == "C2") {
                                                                                                                                        let ApplDefects = resultDef?.filter(i => i?.defectCategoryId == "415")
                                                                                                                                        console.log(ApplDefects);
                                                            ...
                                                            {/* <Form.Check type='checkbox' label="Were multiple products served?" onChange={(e)=>{
if(e.target.checked){
    handleShowMultipleProduct()
}else{
    handleCloseMultipleProduct()
}
}}/> */}



                                                            <GenericModal title="Add Multiple Ticket Information" size="xl" show={showMultipleProdTicket} handleClose={handleCloseMultipleProduct} backdrop="static" IsCentered={true} body={<>


                                                                <div className='d-flex flex-wrap gap-4'>

                                                                    <Form.Group>
                                                                        <Form.Label>Serial No. <span className='req-t'>*</span></Form.Label>
                                                                        <Form.Control type='text' value={addMultpleProductsTable?.serialNo} onChange={(e) => {
                                                                            setaddMultpleProducts((pre) => {
                                                                                return {
                                                                                    ...pre,
                                                                            ...
                                                                            setaddMultpleProductsTable((pre) => {
                                                                                return {
                                                                                    ...pre,
                                                                                    serialNo: e.target.value
                                                                                }
                                                                            ...
                                                                            // debouncedSerailNumberForMultipleProducts(e.target.value)

                                                                            console.log(addMultpleProducts);
                                                                            console.log(addMultpleProductsTable);
                                                                    ...
                                                                    <Form.Group>
                                                                        ...
                                                                        <Form.Control type='text' value={addMultpleProductsTable?.productCode} onChange={(e) => {
                                                                            setaddMultpleProducts({
                                                                                ...addMultpleProducts,
                                                                    ...
                                                                    <Form.Group>
                                                                        <Form.Label>Division</Form.Label>
                                                                        <Form.Control type='text' value={addMultpleProductsTable?.division} readOnly />
                                                                    </Form.Group>


                                                                    <Form.Group>
                                                                        <Form.Label>Product Line</Form.Label>
                                                                        <Form.Control type='text' value={addMultpleProductsTable?.productLine} readOnly />
                                                                    </Form.Group>


                                                                    <Form.Group>
                                                                        <Form.Label>Invoice No. <span className='req-t'>*</span></Form.Label>
                                                                        <Form.Control type='text' value={addMultpleProductsTable?.pInvoiceNo} onFocus={() => {
                                                                            fetch(
                                                                                `${process.env.REACT_APP_API_URL}ServiceTicket/GetAllSerialWiseServiceTicketInfoFIR?SerialNo=${addMultpleProducts?.serialNo}&ProductCode=${addMultpleProducts?.productCode || "0"}&InvoiceDate=${addMultpleProducts?.pInvoiceDate || ""}&DivisionCode=${ticketInfo[0]?.divisionCode}`,
                                                                                {
                                                                                    headers: {
                                                                    ...
                                                                    <Form.Group>
                                                                        <Form.Label>Invoice Date <span className='req-t'>*</span></Form.Label>
                                                                        <Form.Control type='date' value={addMultpleProductsTable?.pInvoiceDate} min={minProdDateForMultipleProds} onChange={(e) => {
                                                                            setaddMultpleProducts({
                                                                                ...addMultpleProducts,
                                                                                pInvoiceDate: e.target.value
                                                                            }
                                                                            )
                                                                    ...
                                                                    <div className='m-auto'>
                                                                        ...
                                                                        <Button variant='' className='mt-3'><FaCirclePlus color='green' fontSize={15} onClick={handleAddMultipleProducts} /></Button>
                                                                    </div>
                                                                ...
                                                                <Table responsive bordered className='mt-2'>
                                                                    ...
                                                                    <tbody>
                                                                        {
                                                                            AddedMultipleProductsTable?.map((product, i) => {
                                                                                return (
                                                                                    <>
                                                                                        <tr style={{ fontSize: "11px" }}>
                                                                                            ...
                                                                                            <td>{product?.pInvoiceNo}</td>
                                                                                            <td>{moment(product?.pInvoiceDate).format("DD-MM-YYYY")}</td>
                                                                                            <td className='text-center'><FaCircleMinus color='red' style={{ cursor: "pointer" }} fontSize={15} onClick={() => handleRemoveMulipleProducts(i)} /></td>
                                                                                        </tr>
                                                                                    </>
                                                                                )
                                                                            })
                                                                ...
                                                                {AddedMultipleProductsTable?.length > 0 ? <Row className='text-center'><Col><Button variant='' className='add-Btn' onClick={() => {
                                                                    console.log(AddedMultipleProducts);
                                                                ...
                                                                (
                                                                    <Row className="gap-3 mt-3 " >
                                                                                                ...
                                                                                                onFocus={() => {
                                                                                                    fetch(`${process.env.REACT_APP_API_URL}DefectCategory/GetAllDefectCategory?DivisionCode=${ticketInfo[0]?.divisionCode}&ProductLineCode=${ticketInfo[0]?.productLineCode}`, {
                                                                                                        ...
                                                                                                        .then((resultDef) => {
                                                                                                            ...
                                                                                                            if (ticketInfo[0]?.divisionCode == "CP" && ticketInfo[0]?.productLineCode == "FD" && ticketInfo[0]?.callTypeId=="145") {
                                                                                                                let FDDefects = resultDef?.filter(i => i?.defectCategoryId == "414")
                                                                                                                console.log(FDDefects);
                                                                                                            ...
                                                                                                            else if (ticketInfo[0]?.divisionCode == "CP" && ticketInfo[0]?.productLineCode == "C2" && ticketInfo[0]?.callTypeId=="145") {
                                                                                                                let ApplDefects = resultDef?.filter(i => i?.defectCategoryId == "415")
                                                                                                                console.log(ApplDefects);
                                                                        ...
                                                                        <Col className='p-3 m-2' style={{
                                                                            ...
                                                                            {(ticketInfo[0]?.tabActive == "Tab3" || ticketInfo[0]?.tabActive == "Tab4") ? "" : <p className='px-2' style={{ fontSize: "12px" }}><b><u>Note: </u></b>  Document Types marked with <span className='req-t'>*</span> are mandatory & File size should be less than 4Mb.
                                                                            </p>}
                                                                            <hr />
                                                                            {(ticketInfo[0]?.tabActive == "Tab3" || ticketInfo[0]?.tabActive == "Tab4") ? "" : <>
                                                                                <Row className="mr-1">
                                                                                            ...
                                                                                            <Row>
                                                                                                ...
                                                                                                <Col md={2}>
                                                                                                    <Button variant='' className='mt-4' onClick={(e) => {
                                                                                                        ...
                                                                                                        else if (uploadDocuments?.DocumentWithType > 1e6) {
                                                                                                            Swal.fire({
                                                                                                                icon: "error",
                                                                                                                title: "Document type lesst"
                                                                                                            })
                                                                                    ...
                                                                                    >
                                                                                        <Button
                                                                                            ...
                                                                                            onClick={(e) => {
                                                                                                ...
                                                                                                else if (ticketInfo[0]?.divisionCode == 'M4' || ticketInfo[0]?.divisionCode == 'DR' || ticketInfo[0]?.divisionCode == 'M3' || ticketInfo[0]?.divisionCode == 'CP') {
                                                                    ...
                                                                    <Row className='gap-3 mt-3 ' style={{
                                                                        ...
                                                                        <div style={{
                                                                            ...
                                                                            {ticketInfo[0]?.tabActive == "Tab3" || ticketInfo[0]?.tabActive == "Tab4" ? "" : <Row>
                                                                                    ...
                                                                                    <Form.Group>
                                                                                        ...
                                                                                        <div className='d-flex gap-4 mx-2'>
                                                                                            ...
                                                                                            <Form.Check type='radio' label="No" name='partConsumption' onChange={(e) => {
                                                                                                ...
                                                                                                if (e.target.checked && ticketInfo[0]?.callTypeId == "145") {
                                                                                                    fetch(`${process.env.REACT_APP_API_URL}Common/GetAllCommon?mode=35&Code=${tab3?.DivisionCode ? tab3?.DivisionCode : 0}&Id=${serTicId}`, {
                                                                                                        headers: {
                                                                                                            Authorization: `Bearer ${token}`,
                                                                                                        },
                                                                                                        ...
                                                                                                        .then((result) => {
                                                                                                            // console.log(result);
                                                                                                            let filterRewinding = result?.filter(i => i?.parameterTypeId == "229")
                                                                                                            console.log(filterRewinding);
                                                                                                ...
                                                                                                if (e.target.checked && !submittedDataTab2?.some(i => i?.activityName?.includes("Rewinding")) && ticketInfo[0]?.callTypeId != "145") {
                                                                                                    ...
                                                                                                    fetch(`${process.env.REACT_APP_API_URL}Common/GetAllCommon?mode=35&Code=${tab3?.DivisionCode ? tab3?.DivisionCode : 0}&Id=${serTicId}`, {
                                                                                                        ...
                                                                                                        .then((result) => {
                                                                                                            // console.log(result);
                                                                                                            let noSpare = result?.filter(i => i?.parameterTypeId != "203")
                                                                                                            console.log(noSpare);

                                                                                                            setClousureStatus(noSpare)
                                                                                                ...
                                                                                                if (e.target.checked && submittedDataTab2?.some(i => i?.activityName?.includes("Repair")) && ticketInfo[0]?.callTypeId != "145") {
                                                                                                    // getClosureStatus()
                                                                                                    ...
                                                                                                    fetch(`${process.env.REACT_APP_API_URL}Common/GetAllCommon?mode=35&Code=${tab3?.DivisionCode ? tab3?.DivisionCode : 0}&Id=${serTicId}`, {
                                                                                                        ...
                                                                                                        .then((result) => {
                                                                                                            console.log(result);
                                                                                                            let filterRepair = result?.filter(i => i?.parameterTypeId == "223")

                                                                                                            console.log(filterRepair);

                                                                                                            setClousureStatus(filterRepair)
                                                                                                ...
                                                                                                if (e.target.checked && submittedDataTab2?.some(i => i?.activityName?.includes("Replacement")) && ticketInfo[0]?.callTypeId != "145") {
                                                                                                    // getClosureStatus()
                                                                                                    ...
                                                                                                    fetch(`${process.env.REACT_APP_API_URL}Common/GetAllCommon?mode=35&Code=${tab3?.DivisionCode ? tab3?.DivisionCode : 0}&Id=${serTicId}`, {
                                                                                                        ...
                                                                                                        .then((result) => {
                                                                                                            // console.log(result);
                                                                                                            let filterRepair = result?.filter(i => i?.parameterTypeId == "202")
                                                                                                            console.log(filterRepair);
                                                                                ...
                                                                                {
                                                                                    ((isASMflow == 'false') && (ticketInfo[0]?.divisionCode == "M7") && (selectPartConsumption == "selected" || ticketInfo[0]?.tabActive == "Tab3" || ticketInfo[0]?.tabActive == "Tab4")) ? (
                                                                                        <>
                                                                                            <Col md={4}>
                                                                                                <Form.Group>
                                                                                                    <Form.Label>Visited By<span className="req-t">*</span></Form.Label>
                                                                                                                    ...
                                                                                                                    fetch(`${process.env.REACT_APP_API_URL}Activity/GetAllTypeOfWorkDone?serviceTicketId=${serTicId}&FrameSizeType=""&KVAType=""`, {
                                                                                                                        ...
                                                                                                                        .then((result) => {
                                                                                                                            if (e.target.checked) {
                                                                                                                                ...
                                                                                                                                //     return {
                                                                                                                                //         ...pre,
                                                                                                                                //         TypeOfWorkDoneId: optionsypeWorkdone
                                                                                                                                //     }
                                                                                                                                // })
                                                                                            ...
                                                                                            {ticketInfo[0]?.divisionCode == "M7" && dis && (showCity) ? <Col md={4}>
                                                                                                                ...
                                                                                                                fetch(`${process.env.REACT_APP_API_URL}Activity/GetAllTypeOfWorkDone?serviceTicketId=${serTicId}&FrameSizeType=""&KVAType=""`, {
                                                                                                                    ...
                                                                                                                    .then((result) => {
                                                                                                                        if (e.target.checked && engSelect && techSelect) {
                                                                                                                            ...
                                                                                                                            let filterEngg = result?.filter(item => item.activityId != '10042' &&
                                                                                                                                item.activityId != '10048' && item.activityId != '10049' && item.activityId != '10044' && item.activityId != '10050')
                                                                            ...
                                                                            {(selectPartConsumption == "selected" || ticketInfo[0]?.tabActive == "Tab3" || ticketInfo[0]?.tabActive == "Tab4") ?
                                                                                <Row className='mt-1 mb-2 '>
                                                                                    ...
                                                                                    {
                                                                                        (
                                                                                            // ticketInfo[0]?.productLineCode != "DC" &&
                                                                                            ticketInfo[0]?.divisionCode == "M3" && FrameList?.length > 0 && (ticketInfo[0]?.tabActive == "Tab2")) ?
                                                                                            <Col md={4}>
                                                                                                <Form.Group>
                                                                                                    ...
                                                                                                    >
                                                                                                        <option value="0">Select</option>
                                                                                                        {
                                                                                                            FrameList?.map((AllFrames, i) => {
                                                                                                                return (
                                                                                                                    <>
                                                                                                                        <option value={AllFrames?.parameterTypeId}>{AllFrames?.parameterType}</option>
                                                                                                                    </>
                                                                                                                )
                                                                                                            })
                                                                                                        }
                                                                                    ...
                                                                                    {(ticketInfo[0]?.productLineCode == "DC" && KVAList?.length > 0 && (ticketInfo[0]?.tabActive == "Tab2")) ? <Col md={4}>
                                                                                        <Form.Group>
                                                                                            ...
                                                                                            <MultiSelect
                                                                                                options={KVAList}
                                                                                                value={selectedKVAList}
                                                                                                onChange={function noRefCheck(e) {
                                                                                                    console.log(e);

                                                                                                    setselectedKVAList(e)

                                                                                                    let KVATypes = e.map(i => i.value).toString()
                                                                                ...
                                                                                ticketInfo[0]?.divisionCode == "CP" && ( */}
                                                                                    {(tab3?.ClosureStatusId == "202" ||
                                                                                        ...
                                                                                        <Form.Group>
                                                                                            <Form.Label>Replacement tag photo <span className="req-t">*</span></Form.Label>
                                                                            ...
                                                                            
                                                                            {
                                                                                ticketInfo[0]?.divisionCode == "CP" && ( */}
                                                                                    {(tab3?.ClosureStatusId == "202" ||
                                                                                        submittedDataTab3?.closureStatusName == "Replacement from dealer") ?
                                                                                        <Col md={4}>
                                                                                            <Form.Group>
                                                                                                <Form.Label style={{
                                                                                                    whiteSpace: 'nowrap'
                                                                                                }}>Replacement tag number <span className="req-t">*</span></Form.Label>
                                                                                                <Form.Control type='text' readOnly={ticketInfo[0]?.tabActive == "Tab3" || ticketInfo[0]?.tabActive == "Tab4"} value={tab3?.ReplacementTagApplied} onChange={(e) => {
                                                                                                    const value = e.target.value;


                                                                                                    const pattern = /^[A-Za-z]{2}[0-9]{4}[A-Za-z]{1}[0-9]{6}$/;


                                                                                                    if (value.length <= 13) {
                                                                                                        settab3((pre) => ({
                                                                                                            ...pre,
                                                                                                            ReplacementTagApplied: value,
                                                                                                        }));

                                                                                                        if (value.length === 13) {
                                                                                                            if (pattern.test(value)) {
                                                                                                                setErrorMessageTagNo('');
                                                                                                            } else {
                                                                                                                setErrorMessageTagNo('Invalid Tag No.');
                                                                                                            }
                                                                                                        } else {
                                                                                                            setErrorMessageTagNo('Input must be 13 characters long.');
                                                                                                        }
                                                                                                    }
                                                                                                }} />

                                                                                                {errorMessageTagNo && <p style={{ color: 'red' }}>{errorMessageTagNo}</p>}
                                                                                    ...
                                                                                    {(tab3?.ClosureStatusId == "202" ||
                                                                                        ...
                                                                                        <Form.Group>
                                                                                            <Form.Label style={{
                                                                                                whiteSpace: 'nowrap'
                                                                                            }}>Replacement Reason <span className="req-t">*</span></Form.Label>
                                                                                            <Form.Select name='ReplacementCategoryId' disabled={ticketInfo[0]?.tabActive == "Tab3" || ticketInfo[0]?.tabActive == "Tab4"} value={tab3?.ReplacementCategoryId} onChange={handleChangeTab3} >
                                                                                                <option value="">Select</option>
                                                                                                {
                                                                                                    replacementReasons?.map((reasons, i) => {
                                                                                                        return (
                                                                                                            <>
                                                                                                                <option value={reasons?.parameterTypeId}>{reasons?.parameterType}</option>
                                                                                                            </>
                                                                                                        )
                                                                                                    })
                                                                                                }
                                                                                    ...
                                                                                    {(ticketInfo[0]?.divisionCode == "CP" && (submittedTypeOfWorkDone?.length > 0 || optionsypeWorkdone?.length > 0)) ?
                                                                                        // <Col md={4}>
                                                                                        ...
                                                                                        //                 </>
                                                                                        //             )
                                                                                        //         }) : optionsypeWorkdone?.length > 0 ? <Form.Select name='TypeOfWorkDoneId' value={tab3?.TypeOfWorkDoneId} disabled={ticketInfo[0]?.tabActive == "Tab3" || ticketInfo[0]?.tabActive == "Tab4"} 
                                                                                        //         onChange={(e)=>{
                                                                                        //             console.log(e.target.value)
                                                                                        //             settab3((pre)=>{
                                                                                        //                 return{
                                                                                        //                     ...pre,
                                                                                        //                     TypeOfWorkDoneId:e.target.value
                                                                                        //                 }
                                                                                        //             })
                                                                                        ...
                                                                                        ""
                                                                                        :
                                                                                        (submittedTypeOfWorkDone?.length > 0 || optionsypeWorkdone?.length > 0) && (ticketInfo[0]?.divisionCode != 'M7' || ticketInfo[0]?.tabActive == 'Tab3') ? <Col md={4}>
                                                                                            <Form.Group>
                                                                                                {/* {((submittedTypeOfWorkDone?.length > 0 || optionsypeWorkdone?.length > 0 || ticketInfo[0]?.divisionCode == 'M4' || ticketInfo[0]?.divisionCode == 'M3' || ticketInfo[0]?.divisionCode == 'CP' || ticketInfo[0]?.divisionCode == 'DR') && (ticketInfo[0]?.divisionCode != 'M7')) ? <Form.Label>Type of work done </Form.Label> : ""} */}
                                                                                                ...
                                                                                                {(ticketInfo[0]?.tabActive == "Tab3" || ticketInfo[0]?.tabActive == "Tab4") ? submittedTypeOfWorkDone?.map((workDone, i) => {
                                                                                                ...
                                                                                                }) : (optionsypeWorkdone?.length > 0 && ticketInfo[0]?.divisionCode != 'M7') ? <MultiSelect
                                                                                                    ...
                                                                                                    onChange={function noRefCheck(e) {
                                                                                                        ...
                                                                                                        if (selectedValue.length < 1 && (ticketInfo[0]?.divisionCode == 'M4' || ticketInfo[0]?.divisionCode == 'CP' || ticketInfo[0]?.divisionCode == 'M3' || ticketInfo[0]?.divisionCode == 'DR')) {
                                                                                                            ...
                                                                                                            fetch(`${process.env.REACT_APP_API_URL}Activity/GetAllTypeOfWorkDone?serviceTicketId=${serTicId}&FrameSizeType=""&KVAType=""`, {
                                                                                                                ...
                                                                                                                .then((result) => {
                                                                                                                    ...
                                                                                                                    if (selectedValue?.includes(10032) || selectedValue?.includes(10033) || selectedValue?.includes(10034)) {
                                                                                                                        const valuesToRemove = [];
                            ...
                            <Form.Group>
                                ...
                                <Form.Control type='text' />
                                                                        ...
                                                                        {(ticketInfo[0]?.tabActive == "Tab3" || ticketInfo[0]?.tabActive == "Tab4") ? "" : <Row className='align-items-center justify-content-center'>
                                                                            <Col md={1}><Button variant='' disabled={errorMessageTagNo} onClick={(e) => {
                                                                                ...
                                                                                else if (tab3?.ClosureStatusId == "202" && tab3?.ReplacementTagFile == '') {
                                                                                    Swal.fire({
                                                                                        icon: "error",
                                                                                        title: "Replacement tag file is required!"
                                                                                    })

                                                                                }
                                                                                else if (tab3?.ClosureStatusId == "202" && tab3?.ReplacementTagApplied == '') {
                                                                                    Swal.fire({
                                                                                        icon: "error",
                                                                                        title: "Replacement tag number is required!"
                                                                                    })

                                                                                }
                                                                                else if (tab3?.ClosureStatusId == "202" && (tab3?.ReplacementCategoryId == '' || tab3?.ReplacementCategoryId == '0')) {
                                                                                    Swal.fire({
                                                                                        icon: "error",
                                                                                        title: "Replacement Reason is required!"
                                                                                    })
                                                                                ...
                                                                                // }
                                                                                    ...
                                                                                    let n = {
                                                                                        ...
                                                                                        TypeOfWorkDoneId: ticketInfo[0]?.divisionCode == 'CP' ? '0' : tab3?.TypeOfWorkDoneId?.map(i => i.value).join(","),

                                                                                        // TypeOfWorkDoneId: ticketInfo[0]?.divisionCode=='M3'? optionsypeWorkdone?.map(value => value?.value).join(","):tab3?.TypeOfWorkDoneId?.map(i => i.value).join(","),
                                                                                        ...
                                                                                        FailureReportedDate: tab3?.FailureReportedDate,
                                                                                        ProductFailureDate: tab3?.ProductFailureDate,
                                                                                        TypeOfFrame: tab3?.TypeOfFrame,
                                                                                        TypeOfKVA: tab3?.TypeOfKVA
                                                                ...
                                                                <Row>
                                                                    ...
                                                                    <>
                                                                        ...
                                                                        {((acknowledgementStatus == "Customer Contacted" && !isshowexists) && isDistance60) && (
                                                                            <Row className="justify-content-center text-center">
                                                                                {(ticketInfo[0]?.divisionCode === 'M7' || ticketInfo[0]?.divisionCode == 'CP' || ticketInfo[0]?.tabActive === "Tab4") ? "" : (
                                                                                    <>
                                                                                        <Col lg={12} md={6} sm={12}>
                                                                                                                ...
                                                                                                                if (e.target.checked) {
                                                                                                                    ...
                                                                                                                    settab4Deviation((pre) => {
                                                                                                                        return {
                                                                                                                            ...
                                                                                                                            SysDistance: ticketInfo[0]?.distance,
                                                                                                                            ClaimDeviationTypeId: ticketInfo[0]?.divisionCode == 'DR' ? "4" : ticketInfo[0]?.divisionCode == 'M4' ? "3" : ticketInfo[0]?.divisionCode == 'M3' ? "8" : '0'
                                                                                                ...
                                                                                                <Col md={4}>
                                                                                                    <Form.Group>
                                                                                                        ...
                                                                                                        <Form.Select value={tab4Claim?.modeOftravel} name='modeOftravel' onChange={handleChangetabClaim}>
                                                                                                            ...
                                                                                                            {ticketInfo[0]?.divisionCode === 'DR' || ticketInfo[0]?.divisionCode === 'M3' ? "" : (
                                                                                                                <option value='car'>Car</option>
                                                                                                            )}
                                                                        ...
                                                                        {
                                                                            ((ticketInfo[0]?.tabActive == "Tab4" || ticketInfo[0]?.divisionCode == "M7" || ticketInfo[0]?.divisionCode == "CP") || !isDistance60 || isshowexists || acknowledgementStatus === 'Product received at workshop') && (

                                                                                <Row>

                                                                                    {!(acknowledgementStatus === 'Product received at workshop' || ticketInfo[0]?.tabActive === "Tab4") && (
                                                                                        <Row>
                                                                                            {devationData.length > 0 && (
                                                                                                <Col md={4}>
                                                                                                    <Form.Group>
                                                                                        ...
                                                                                        <Table responsive bordered className="mt-1">
                                                                                            <thead className='docTable'>
                                                                                                ...
                                                                                                >
                                                                                                    ...
                                                                                                    <th className='m-0 pl-1 py-1 align-content-center text-center'>Type</th>
                                                                                                    <th className='m-0 pl-1 py-1 align-content-center text-center'>Activity</th>
                                                                                                    <th className='m-0 pl-1 py-1 align-content-center text-center'>Parameter</th>
                                                                                                    <th className='m-0 pl-1 py-1 align-content-center text-center'>Rate</th>
                                                                                                    <th className='m-0 pl-1 py-1 align-content-center text-center'>Quantity</th>

                                                                                                    <th className='m-0 pl-1 py-1 align-content-center text-center'>Claim amount</th>
                                                                                                ...
                                                                                                {claimInfo?.map((add, index) => {
                                                                                                    ...
                                                                                                    return (
                                                                                                        <>
                                                                                                            ...
                                                                                                            <tr className={`${add?.isDeviation == "1" ? 'trcolor' : add?.isDeviation == "2" ? 'trcolor2' : 'normalColor'}`}
                                                                                    ...
                                                                                    {
                                                                                        (SpecialApprovals?.length > 0 && (SpecialApprovals[0]?.approvalStatus == "Pending for Approval")) ?
                                                                                            <>
                                                                                                <p className='m-0' style={{ fontWeight: "500" }}>Special Approval</p>
                                                                                                <Table responsive bordered className='mt-1'>
                                                                                                    <thead className='docTable'>
                                                                                                        <tr style={{
                                                                                                            fontSize: "12px",
                                                                                                        }}>
                                                                                                            <th className='m-0 pl-1 py-1 align-content-center text-center'>Service ticket No.</th>
                                                                                                            <th className='m-0 pl-1 py-1 align-content-center text-center'>Claim Amount</th>
                                                                                                            <th className='m-0 pl-1 py-1 align-content-center text-center'>Remarks</th>
                                                                                                            <th className='m-0 pl-1 py-1 align-content-center text-center'>Special Approval By</th>
                                                                                                            <th className='m-0 pl-1 py-1 align-content-center text-center'>Date of Creation</th>
                                                                                                            <th className='m-0 pl-1 py-1 align-content-center text-center'>Approval Status</th>
                                                                                                            <th className='m-0 pl-1 py-1 align-content-center text-center'>Approval Remarks</th>
                                                                                                        </tr>
                                                                                                    </thead>
                                                                                                    <tbody>
                                                                                                        {
                                                                                                            SpecialApprovals?.map((spApprove, i) => {
                                                                                                                return (
                                                                                                                    <>
                                                                                                                        <tr>
                                                                                                                            <td className='m-0 pl-1 py-1 align-content-center'>{spApprove?.serviceTicketNo}</td>
                                                                                                                            <td className='m-0 pl-1 py-1 align-content-center'>{spApprove?.claimAmount}</td>
                                                                                                                            <td className='m-0 pl-1 py-1 align-content-center'>{spApprove?.remarks}</td>
                                                                                                                            <td className='m-0 pl-1 py-1 align-content-center'>{spApprove?.createdBy}</td>
                                                                                                                            <td className='m-0 pl-1 py-1 align-content-center'>{spApprove?.specialApprovalCreatedOn}</td>
                                                                                                                            <td className='m-0 pl-1 py-1 align-content-center'>{spApprove?.approvalStatus}</td>
                                                                                                                            <td className='m-0 pl-1 py-1 align-content-center' style={{ color: `${spApprove?.approvalStatus == "Pending for Approval" ? 'orange' : ""}`, fontWeight: "bold" }}>{spApprove?.approvalRemarks}</td>
                                                                                    ...
                                                                                    {ticketInfo[0]?.tabActive == "Tab4" ? "" : <Row className='justify-content-center align-items-center'>
                                                                                        <Col md={2}><Button variant='' className='add-Btn' onClick={handleSubmitClaim} disabled={SpecialApprovals[0]?.approvalStatus == "Pending for Approval"}>Submit</Button></Col>
                                                                                    </Row>}
                                                                                </Row>
                                                                            )
                                                                        }
                                ...
                                <Row>
                                    ...
                                    <Col md={6}>
                                        <Form.Group>
                                            ...
                                            <Form.Control type='text'
                                                onChange={handleChangetab4Deviation} maxLength={3} name='CurrentDistance' value={tab4Deviation?.CurrentDistance} />
                                ...
                                <Row className="justify-content-center text-center">
                                    <Col lg={12} md={6} sm={12}>
                                        ...
                                        {((
                                            ...
                                            (ticketInfo[0]?.divisionCode === 'M3' && isDistanceAbove30) ||
                                            (ticketInfo[0]?.productLineCode === 'C1' && isDistanceAbove30) ||
                                            // (ticketInfo[0]?.divisionCode === 'CP' && isDistanceAbove30) ||
                                            (ticketInfo[0]?.divisionCode === 'M4')) && !isshowexists && isDistanceAbove250 ? (
                                            <Form.Check
                                                type="radio"
                                                label="Same day"
                                                name="radioGroup"
                                        ...
                                        }
                                        {
                                            ((ticketInfo[0]?.divisionCode === 'DR' && isDistanceAbove100) ||
                                                (ticketInfo[0]?.divisionCode === 'M7' && isDistanceAbove100) ||
                                                (ticketInfo[0]?.divisionCode === 'M3' && isDistanceAbove30) ||
                                                (ticketInfo[0]?.productLineCode === 'C1' && isDistanceAbove200) ||
                                                // (ticketInfo[0]?.divisionCode === 'CP' && isDistanceAbove30) ||
                                                (ticketInfo[0]?.divisionCode === 'M4')) && !isshowexists ? (
                                                <Form.Check
                                                    type="radio"
                                                    label="Overnight Stay"
                                                    name="radioGroup"
                                            ...
                                            <Col md={4}>
                                                <Form.Group>
                                                    ...
                                                    <Form.Select value={tab4Deviation?.modeOftravel} name='modeOftravel' onChange={handleChangetab4Deviation}>
                                                        <option value=''>Select</option>
                                                        <option value='Bike'>Bike</option>
                                                        {ticketInfo[0]?.divisionCode === 'DR' || ticketInfo[0]?.divisionCode === 'M3' || ticketInfo[0]?.productLineCode === 'C1' ? "" : (
                                                            <option value='car'>Car</option>
                                                        )}
                    ...
                    <GenericModal show={showRequestInfo} handleClose={handleCloseServiceRequest} size='l' backdrop="static" IsCentered='centered' className='mdl-title' title=""
                        body={
                            <>
                                {
                                    RoleName == "AS8" || tab1?.serviceRequestSubStatusId == '24' ? 
                    ...
                    <GenericModal show={showProductInfo} handleClose={handleCloseProductinfo} size='xl' backdrop="static" IsCentered='centered' className='mdl-title' title="Service request Info"
                        body={
                            <>
                                <Card className="p-3">
                                    <Row>
                                        <Col lg={12} md={12} sm={12}>
                                            <Card className='p-2' style={{ boxShadow: "0px 0px 2px 2px rgba(176,195,212,1)" }}>
                                                <Row>
                                                    ...
                                                    <Col lg={3} md={6} sm={6}>
                                                        <p className='m-0' style={{ fontSize: "12px" }}>Customer type</p>
                                                        <p className='mt-1' style={{ fontWeight: "500", fontSize: "12px" }}>{ticketInfo[0]?.typeOfCustomer ? ticketInfo[0]?.typeOfCustomer : ''}
                                                        </p>
                                                    </Col>
                                                    <Col lg={3} md={6} sm={6}>
                                                    ...
                                                    <Col lg={3} md={6} sm={6}>
                                                        <p className='m-0' style={{ fontSize: "12px" }}>Product Serial No</p>
                                                ...
                                                <Row>
                                                    ...
                                                    <Col lg={3} md={6} sm={6}>
                                                        <p className='m-0' style={{ fontSize: "12px" }}>Distance (in Km Both side)</p>
                                                        <p className='mt-1' style={{ fontWeight: "500", fontSize: "12px" }}>{ticketInfo[0]?.distance}
                                                        </p>
                                                    </Col>
                                                ...
                                                <Row>
                                                    ...
                                                    <Col lg={3} md={6} sm={6}>
                                                        <p className='m-0' style={{ fontSize: "12px" }}>Call type</p>
                                                        <p className='mt-1' style={{ fontWeight: "500", fontSize: "12px" }}>{ticketInfo[0]?.callType}
                                                        </p>
                                                    </Col>
                                                    <Col lg={3} md={6} sm={6}>
            ...
            <GenericModal title="Change the Product" IsCentered={true} size="xl" show={showProdChange} handleClose={handleCloseProdChange} backdrop="static" body={
                <>
                    ...
                    <Row>
                                ...
                                <Form.Control
                                    ...
                                    onChange={(e) => {
                                        ...
                                        timeoutId = setTimeout(() => {
                                            fetch(
                                                `${process.env.REACT_APP_API_URL}ServiceTicket/GetAllSerialWiseServiceTicketInfoFIR?SerialNo=${value}&ProductCode=${changeProduct?.productCode ? changeProduct?.productCode : "0"}&InvoiceDate=${changeProduct?.invoiceDate || ""}&DivisionCode=${ticketInfo[0]?.divisionCode}`,
                                                {
                                                    headers: {
                                                        Authorization: `Bearer ${token}`,
                                                    },
                                                ...
                                                .then((result) => {
                                                    ...
                                                    a = moment(a).format("YYYY-MM-DD")
                                                    let d1 = new Date(a);
                                                    let d2 = new Date(changeProduct.invoiceDate);
                                                    // console.log(a, 'a---------')
                                                    setMinInvoiceDateProdChange(a);
                                                    if (d1 > d2) {
                                                        settab1((pre) => {
                                                            return {
                                                                ...pre,
                                                    ...
                                                    // Additional logic for date formatting, etc.
                                                    //   if (ticketInfo[0]?.divisionCode !== 'M7') {
                                                    //     let a = result[0]?.batchStartDate;
                                                    //     a = moment(a).format("YYYY-MM-DD");
                                                    //     let d1 = new Date(a);
                        ...
                        <Col md={2}>
                            <Form.Group >
                                ...
                                <Form.Control
                                    type="text"
                                    // name="ProductCode"
                                    value={changeProduct.productCode}
                        ...
                        <Col md={2}>
                            <Form.Group>
                                ...
                                <Form.Control type='text' readOnly value={changeProduct?.divisionName} />
                            </Form.Group>
                        </Col>
                        <Col md={2}>
                            <Form.Group>
                                <Form.Label>Product-Line <span className='req-t'>*</span></Form.Label>
                                <Form.Control type='text' readOnly value={changeProduct?.productLineName} />
                            </Form.Group>
                        </Col>
                        <Col md={2}>
                            <Form.Group>
                                <Form.Label>Invoice Date <span className='req-t'>*</span></Form.Label>
                                <Form.Control type='date' min={minInvoiceDateProdChange} value={moment(changeProduct?.invoiceDate)?.format("YYYY-MM-DD")} />
                            </Form.Group>
                        </Col>
                        <Col md={2}>
                            <div className='mt-1'>

                                <Button variant='' className='add-Btn mt-4' onClick={(e) => {
...
export default NewAssignRequestInt